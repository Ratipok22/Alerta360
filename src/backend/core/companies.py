...
COMPANIAS: tuple[Compania, ...] = (
    ...
    Compania("CB Valparaíso", "15", 'Decimoquinta Compañía "Bomba Israel"', "Av. Rodelillo s/n, esquina Jardín de Abadía, Cerro Rodelillo",
    ...
    Compania("CB Viña del Mar", "V6", "Sexta Compañía", "Vergara 1115, Concón",
